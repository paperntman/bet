        ...
        jda.getGuilds().forEach(guild -> {
            final Thread thread = new Thread(() -> {
                try {
                    ...
                    guild.upsertCommand(Commands.slash("betstart", "베팅을 시작합니다.").addOption(OptionType.STRING, "제목", "베팅의 제목입니다!", true).addOption(OptionType.STRING, "option_1", "1번 선택지입니다.", true).addOption(OptionType.STRING, "option_2", "2번 선택지입니다.", true).addOption(OptionType.INTEGER, "time", "투표를 진행할 시간(단위: 초)입니다. 선택하지 않을 시 1분 동안 진행됩니다.")).queue();
